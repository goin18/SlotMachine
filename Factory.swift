...
//  SlotMachine
//
//  Created by Marko Budal on 02/01/15.
...
class Factory {
    //koda ki poskrbi za inicializacijo, lahko bi imeli tudi drugje
    // ampak pol je koda malo preveč 
    ...
    class func createSlots() -> [[Slot]] {
        ...
        for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber{
            ...
            for var slotNumber = 0; slotNumber < kNumberOfSlots; ++slotNumber{
               // var slot = Slot(value: 0, image: UIImage(named: ""), red: true)
    ...
    class func createSlot(curentCards:[Slot]) -> Slot {
        var curentCardValues:[Int] = []
        for slot in curentCards {
            curentCardValues.append(slot.value)
        }
        
        var randomNumber = Int(arc4random_uniform(UInt32(13)))
        while contains(curentCardValues, randomNumber + 1) {
